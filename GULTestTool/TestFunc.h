...
private:
    ...
    bool GNSSTimeToUTCSecTime(const QString testData, QString& result);
    bool UTCTimeToGNSSTime(const QString testData, QString& result);
    bool UTCTimeToGNSSSecTime(const QString testData, QString& result);
    bool GNSSTimeConvert(const QString testData, QString& result);
    bool WeekSecToSec(const QString testData, QString& result);
