...
namespace sixents
{
    ...
    {
        // bool类型
        using BOOL_T = bool; ///< 注意此类型不能用于vector容器
        ...
        {
            /// DF002: 电文类型号,用于区分差分电文。Message Type 1020
            UINT16 m_ui16MsgType = 0U;
            ...
            UINT8 m_ui8GmFt = 0U;
            /** DF129: 以四年为间隔的，从闰年的一月一日开始的 GLONASS 日历天数。如果 DF129 不为零，则其值是与参数 t
             *  b 相应日历天数的计算值。
             */
            UINT16 m_ui16GmNt = 0U;
            /** DF130:  GLONASS 卫星类型。01 = GLONASS - M 卫星，所有 GLONASS - M 数据字段均有效；00 = 非 GLONASS -
             *  M 卫星，所有 GLONASS - M 数据字段无效。
             */
            UINT8 m_ui8GmM = 0U;
