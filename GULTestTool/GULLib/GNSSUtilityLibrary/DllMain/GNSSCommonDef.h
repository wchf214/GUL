...
namespace sixents
{
    namespace GNSSUtilityLib
    {
        ...
        const static double LEAPSEC_INFO[65][7] = { /* leap seconds (y,m,d,h,m,s,utc-gpst) */
{2017,1,1,0,0,0,-18},
{2015,7,1,0,0,0,-17},
{2012,7,1,0,0,0,-16},
{2009,1,1,0,0,0,-15},
...
#define OMGE_CMP 7.292115E-5      /* earth angular velocity (rad/s) ref [9] */
        ...
        const time_t DAYSEC = 86400;
        const time_t DAYOFWEEK = 7;

        const time_t GPSWEEK_TO_GALWEEK = 1024;
        const time_t GPSWEEK_TO_BDSWEEK = 1356;

        const time_t GLOSEC_TO_UTCSEC = 10800;
        const time_t EPOCH_ADD_YEAR = 1900;

        const time_t GPSLEAP_TO_BDSLEAP = 14;
